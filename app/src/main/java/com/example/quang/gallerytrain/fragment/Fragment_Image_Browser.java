...
public class Fragment_Image_Browser extends Fragment implements imageIndicatorListener {
    ...
    public Fragment_Image_Browser(){

    }

    public Fragment_Image_Browser(ArrayList<Images> allImages, int imagePosition, Context anim) {
        this.allImages = allImages;
        this.position = imagePosition;
        this.animeContx = anim;
    }

    public static Fragment_Image_Browser newInstance(ArrayList<Images> allImages, int imagePosition, Context anim) {
        Fragment_Image_Browser fragment = new Fragment_Image_Browser(allImages,imagePosition,anim);
        return fragment;
    }
