...
public class recyclerViewPagerImageIndicator extends RecyclerView.Adapter<indicatorHolder> {
     ...
     */
    public recyclerViewPagerImageIndicator(ArrayList<Images> pictureList, Context pictureContx, imageIndicatorListener imageListerner) {
